<form action="{{route('marcas.update')}}" method="POST" autocomplete="off" id="frmEditMarca">
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" name="ma_nombre" value="{{$marca->ma_nombre}}" class="form-control" style="text-transform:uppercase;">
        </div>
        <div class="form-group">
            <label for="message-text" class="form-control-label">Contacto:</label>
            <input type="text" name="ma_contacto" value="{{$marca->ma_contacto}}" class="form-control" style="text-transform:uppercase;">
        </div>
        <div class="form-group">
            <label for="message-text" class="form-control-label">Correo:</label>
            <input type="text" name="ma_correo" value="{{$marca->ma_correo}}" class="form-control" style="text-transform:uppercase;">
        </div>
        <div class="form-group">
            <label for="message-text" class="form-control-label">Teléfono:</label>
            <input type="text" name="ma_telefono" value="{{$marca->ma_telefono}}" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
        </div>
    </div>
