<form action="{{route('productores.update')}}" method="POST" autocomplete="off" id="frmEditProductor">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="pr_nombre" value="{{$productor->pr_nombre}}" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="pr_correo" value="{{$productor->pr_correo}}" class="form-control">
        </div>
        <div class="form-group">
            <label for="message-text" class="form-control-label">Teléfono:</label>
            <input type="text" name="pr_telefono" value="{{$productor->pr_telefono}}" class="form-control">
        </div>
        <div class="form-group">
